...
// answer: 1. Так как null, 0, undefined falsy значения

// 2 задача:
// Что выведет код ?
// console.log(5 && null && 10);
// answer: null. Потому что это первое «ложное» значение из списка

// 3 задача:
// Что выведет код ?
// console.log(null || 2 && 3 || 4);
// answer: 3. Приоритет оператора && выше, чем ||, поэтому он выполнится первым. Результат 2 && 3 = 3, поэтому выражение приобретает вид (null || 3 || 4)
...
// answer: 'один' и 'три' (-1 || 0) т.к.-1 это (true), (-1 && 0) 0 это (false), (null || -1 && 1) 1 это (true)